...
,B.PRZYCHODY_RAZEM LAST_PRZYCHODY
...
,CASE WHEN ZMIANA_ROS <= -3 AND ZMIANA_ROE<=-2 THEN 1 ELSE 0 END WL_ROS_ROE
 ,A.K1, A.QR, A.CR, A.WOD, A.ROS,A.LAST_ROS, A.ZMIANA_ROS,A.ROE, A.LAST_ROE, A.ZMIANA_ROE, A.PRZYCHODY_RAZEM,A.LAST_PRZYCHODY, A.ZMIANA_PRZYCHODY, A.DZWIGNIA, A.LAST_DZWIGNIA, A.ZMIANA_DZWIGNIA, A.DATA_POROW
